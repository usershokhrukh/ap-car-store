...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: `${theme == "light" ? "rgb(from #1E222D r g b / 1)" : "rgb(from var(--app-sidebar) r g b / 1)"}`,
      }}
    >
      {windowWidth >= 1000 ? (
        <div
      ...
      <div className="sidebar__bottom">
        <ul className="sidebar__ul">
          ...
          <Link className="sidebar__link" href={"/pickup-points"}>
            <li className="sidebar__list">
              <span className="sidebar__li-span">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="sidebar__li-txt">Pickup points</p>
            </li>
          </Link>
          {windowWidth >= 1000 ? (
            <span className="sidebar__li-box">
              ...
              <Link className="sidebar__link" href={"/admins"}>
                <li className="sidebar__list">
                  ...
                  <p className="sidebar__li-txt">Admins</p>
                </li>
              </Link>
            </span>
          ) : (
