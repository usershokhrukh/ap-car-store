    ...
    <table className="products__table">
      <thead className="products__t-head">
        <tr className="products__t-h-row">
          ...
          <th className="products__t-h-th">Address</th>
          <th className="products__t-h-th">Products count</th>
          <th className="products__t-h-th">Is open now</th>
          <th className="products__t-h-th">Phone</th>
        ...
        {data?.data?.items?.map(
          ({
            ...
            >
              ...
              <td className="products__t-b-td">{address}</td>
              <td className="products__t-b-td">
                <span className="products__t-stock">{productsCount}</span>
              </td>
              <td className="products__t-b-td">
                {isOpenNow ? <span className="products__t-b-status-success products__t-b-status-se">Open</span> : <span className="products__t-b-status-error products__t-b-status-se">Closed</span>}
              </td>
              <td id="switch" className="products__t-b-td">
                <a id="switch" href={`tel:${phone}`} className="products__t-phone">{phone}</a>
              </td>
              <td
